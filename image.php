						...
						<div id="post-<?php the_ID(); ?>" <?php post_class('image-attachment'); ?>>
							...
							<div class="page-header">
								...
								<?php echo shprinkone_get_post_meta(true, true, true, false, false) ?><?php
									...
									printf( __( '<div class="post-meta">Full size: <a href="%1$s" title="Link to full-size image">%2$s &times; %3$s</a> in <a href="%4$s" title="Return to %5$s" rel="gallery">%6$s</a></div>', 'shprinkone' ),
